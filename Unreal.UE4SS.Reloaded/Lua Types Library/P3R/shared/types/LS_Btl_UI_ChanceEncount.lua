...
function USequenceDirector_C:SequenceEvent__ENTRYPOINTSequenceDirector_4(BP_BtlEncountAssistant) end
---@param BP_BtlEncountAssistant ABP_BtlEncountAssistant_C
function USequenceDirector_C:SequenceEvent__ENTRYPOINTSequenceDirector_3(BP_BtlEncountAssistant) end
---@param BP_BtlEncountAssistant ABP_BtlEncountAssistant_C
...
---@param BP_BtlEncountAssistant ABP_BtlEncountAssistant_C
function USequenceDirector_C:RequestSunnmonEnemy(BP_BtlEncountAssistant) end
---@param BP_BtlEncountAssistant ABP_BtlEncountAssistant_C
---@param CueId int32
function USequenceDirector_C:PlaySE(BP_BtlEncountAssistant, CueId) end
---@param BP_BtlEncountAssistant ABP_BtlEncountAssistant_C
function USequenceDirector_C:BP_BtlEncountAssistant_Event_0(BP_BtlEncountAssistant) end
